...
public class Hash {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (input.equals("y")) {
                System.out.print("Enter the name of the input file (you don't have to list the full path, just the file name): ");
    ...
    private static String farthestFromHash() {
        return Collections.max(dist.entrySet(), Map.Entry.comparingByValue()).getKey();
    }
